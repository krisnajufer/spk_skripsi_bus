...
<center><img class="img-fluid mt-4 animated flash" style="height: 75px;width: auto;" src="<?= base_url('assets/img/sp1.jpeg') ?>"></center>
		...
		<div class="card shadow animated fadeInLeftBig border-bottom-info shadow h-100 py-2 my-3" id="manual">
			...
			<div class="card-body">
				...
				<form id="fdaftar" method="POST" autocomplete="off">
					...
					<p class="text-danger text-center">Username dan Password minimal 4 karakter</p>
					<div class="form-group form-label-group">
						<label for="nama" class="small">Masukkan Nama</label>
						<input type="text" min="4" name="nama" id="nama" class="form-control text-center" placeholder="Masukkan Nama Lengkap" autofocus required="yes">
					</div>
				</form>
