...
<body id="page-top">
	...
	<div id="wrapper">
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item <?php if($p=='perusahaan'||$p=='kriteria'||$p=='pertanyaan'||$p=='perhitungan'){echo "active";} ?>">
				<a class="nav-link <?php if($p!='perusahaan'||$p!='kriteria'||$p!='pertanyaan'||$p!='perhitungan'){echo "collapsed";} ?>" href="#" data-toggle="collapse" data-target="#InsertData" aria-expanded="true" aria-controls="collapseTwo">
					<i class="fas fa-fw fa-database"></i>
					<span>Master Data</span>
				</a>
				<div id="InsertData" class="collapse <?php if($p=='perusahaan'||$p=='kriteria'||$p=='pertanyaan'||$p=='perhitungan'){echo "show";} ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Inputkan Data :</h6>
						<a class="collapse-item <?php if($p=='perusahaan'){echo "active";} ?>" href="<?= base_url('perusahaan') ?>">
							<i class="fas fa-fw fa-angle-right"></i> Data Perusahaan
						</a>
